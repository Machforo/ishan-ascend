...
export default function PlacementsPage() {
  ...
  const defaultSections: Record<string, React.ReactNode> = {
    ...
    stats_bar: (
      <div key="stats_bar" className="container-wide pt-12 md:pt-16">
    ...
    process: (
      <div key="process" className="container-wide">
    ...
    recruiters: (
      <div key="recruiters" className="container-wide">
    ...
    success_stories: (
      <div key="success_stories" id="testimonials" className="container-wide scroll-mt-24 mb-16">
          ...
          <div className="grid sm:grid-cols-2 gap-6">
            {testimonials.map((t: any, i: number) => (
              <div key={t.name || i} className="p-6 rounded-xl border bg-card">
                {(t.quote || t.message || t.feedback) && <p className="text-sm text-foreground/70 leading-relaxed italic mb-4">"{t.quote || t.message || t.feedback}"</p>}
    ...
    gallery: data?.recruiterInteractionPhotos?.length > 0 ? (
      <div key="gallery" className="container-wide pb-16">
  ...
  const defaultOrder = ["header", "stats_bar", "recruiters", "process", "success_stories", "gallery", "cta"];
